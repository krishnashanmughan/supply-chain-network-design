...
- **Expansion Cost Threshold:** Expanding the Birmingham depot remains the optimal structural choice until the expansion cost reaches $4,000. Beyond this threshold (e.g., at $5,000), the solver automatically abandons the capital expenditure. Instead, it dynamically reroutes the excess product volume through the London facility, capping the total network cost at $175,000.
- **Network Robustness:** The core depot configuration (London, Exeter, Northampton, Birmingham) remained structurally optimal even when customer demand scaled up by 20% and down by 20%, proving the network design is highly resilient to market volatility. Furthermore, during the 20% market contraction simulation, the model intelligently recognized that the Birmingham capacity expansion was no longer necessary, automatically avoiding the $3,000 expansion fee and dropping total network costs to $130,900.
